package com.example.splitease.ui.Groups.DetailedGroup
...
import com.example.splitease.ui.Groups.DetailedGroup.AddUpdateTransaction.AddTransaction
import com.example.splitease.ui.Groups.DetailedGroup.Adapter.TransactionsAdapter
import com.example.splitease.ui.Groups.DetailedGroup.Adapter.UsersAdapter
import com.example.splitease.ui.Groups.DetailedGroup.SettleUp.SettleUp
...
class DetailedGroup : AppCompatActivity(), TransactionsAdapter.ItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.settleBtn).setOnClickListener {
            startActivity(Intent(this@DetailedGroup, SettleUp::class.java))
        }
